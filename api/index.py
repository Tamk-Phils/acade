...
class StripIndexPyASGI:
    """
    ASGI middleware wrapper that intercepts requests rewritten by Vercel
    (e.g., /api/index.py/academic-data or /api/index.py) and normalizes the path
    so FastAPI routes (/api/academic-data, /api/health) match directly.
    """
...
try:
    ...
    app = StripIndexPyASGI(backend_app)
